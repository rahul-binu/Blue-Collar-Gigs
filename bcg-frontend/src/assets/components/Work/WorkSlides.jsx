                        ...
                        <div className="col-5 p-3" key={work.jobId}>
                            <div className="card bg p-3">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        <div className="car px-3 py-2 align-item-center bg-success text-light"
                                            style={{ backgroundColor: '', borderRadius: '25px', cursor: 'pointer', transition: 'transform 0.3s ease' }}
